#' @title
#' Estimate of linear regression parameter from AIPW2
...
aipw2<-function(cvstr="unstructured",Dep,Id,Time,m,n,data)
{
  InD<-Dep
  dat1<-data
  #-----------------------------------------------------------------------------
...
utils::globalVariables(c("cov","var","cor","na.omit","InD"))
